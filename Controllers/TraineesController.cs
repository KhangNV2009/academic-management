...
namespace AcademicManagement.Controllers
{
    public class TraineesController : Controller
    {
        ...
        public TraineesController(AcademicContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Age,DateOfBirth,Education,MainProgrammingLanguage,TOEICScore,ExperienceDetails,Department,Location,Id,Email,Password,Name,Telephone")] Trainee trainee)
        {
            if (id != trainee.Id)
            {
                return NotFound();
